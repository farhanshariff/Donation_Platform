...
$sql = "SELECT * FROM homeappliance where ha_id='$cat'";
...
session_start();
$user=$_SESSION['email'];
$sql2="select u_id from users where email='$user'";
...
$sql1="UPDATE homeappliance SET status=0,uc='$uid' WHERE ha_id='$cat'";
